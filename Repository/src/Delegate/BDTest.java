...
public class BDTest {
	...
	private BDTest() {
		...
		ProcedimientoDTO p = new ProcedimientoDTO(1, "Curso de manejo para maquinas grandes", "URL 1", 1, (float)9.3, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(2, "Paseo por el campo en tractor", "URL 2", 7, (float)9, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(3, "400 horas de practica con tractor", "URL 3", 400, (float)8.5, false);
		ps.add(p);
		this.cargarProc(p);
		...
		p = new ProcedimientoDTO(4, "Accion 1", "URL 1", 1, (float)9.5, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(5, "Accion 2", "URL 2", 3, (float)9, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(3, "400 horas de practica con tractor", "URL 3", 400, (float)8.5, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(7, "Accion 4", "URL 4", 2, (float)7, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(8, "Accion 5", "URL 5", 1, (float)5.3, false);
		ps.add(p);
		this.cargarProc(p);
		...
		ps = new ArrayList<ProcedimientoDTO>();
		p = new ProcedimientoDTO(9, "Accion 1", "URL 1", 2, (float)9.3, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(10, "Accion 2", "URL 2", 7, (float)8, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(11, "Accion 3", "URL 3", 2, (float)7.6, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(12, "Accion 4", "URL 4", 1, (float)5, false);
		ps.add(p);
		this.cargarProc(p);
		p = new ProcedimientoDTO(13, "Accion 5", "URL 5", 1, (float)3.4, false);
		ps.add(p);
		this.cargarProc(p);
