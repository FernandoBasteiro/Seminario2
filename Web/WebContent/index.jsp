		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-controls="collapse1"> <i
					class="fas fa-fw fa-flag-checkered"></i> <span>Metas</span>
			</a>
				<div id="collapse1" class="collapse" aria-labelledby="headingDos"
			...
			<div id="content">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							<div
								...
								<a class="dropdown-item"
									onclick="loadDiv('contenedor-principal','Servlet','action=listarPerfil', 'Modificar perfil')">
				...
				<div class="container-fluid" id="contenedor-principal" align="center">
						...
						<div class="video-container">
							<iframe width="560" height="315" src="https://www.youtube.com/embed/cfcEkW6BWXM?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						<br>
						<!-- <img src="assets/img/FullLogo.png" style="max-width:100%"> -->
						<%
	...
	<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">Elegí "Salir" si querés cerrar tu
					sesión.</div>
